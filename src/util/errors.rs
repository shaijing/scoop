pub type ScoopResult<T> = anyhow::Result<T>;

pub type CliResult = Result<(), CliError>;

#[derive(Debug)]
/// The CLI error is the error type used at Scoop's CLI-layer.
///
/// All errors from the lib side of Scoop will get wrapped with this error.
